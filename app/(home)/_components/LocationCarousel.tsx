...
export default function LocationCarousel({ category, title, subtitle }: LocationCarouselProps) {
    ...
    const fetchLocations = async () => {
      try {
        ...
        if (Array.isArray(data)) {
          ...
          console.error('Expected array from carousel-locations API, got:', typeof data);
          setLocations([]);
        }
      } catch (error) {
  ...
  return (
    <section className="py-8 overflow-hidden">
      ...
      <div className="relative">
        ...
        <div 
          ref={scrollRef}
          className="flex gap-6 overflow-x-scroll scroll-smooth px-6"
        ...
        {locations.map((location, index) => (
          <Link 
            ...
            className="relative group shrink-0 w-[280px] bg-white rounded-xl shadow-sm transform-gpu transition-all duration-200 hover:shadow-md hover:scale-105 hover:-translate-y-2 hover:z-30 cursor-pointer"
          >
            <div className="relative h-56 bg-gray-200 rounded-xl overflow-hidden">
